{{-- resources/views/restaurant/requisitions/index.blade.php --}}
...
<div class="space-y-6">
    ...
    <div class="filter-card">
        <form method="GET" action="{{ route('restaurant.requisitions.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div>
            ...
            <div class="flex items-end">
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('restaurant.requisitions.index') }}" class="bg-gray-300 text-gray-700 px-3 py-2 rounded-lg text-xs hover:bg-gray-400">
                        <i class="fas fa-times mr-1"></i> Clear
                    </a>
                </div>
            </div>
            <div class="flex justify-end">
                <a href="{{ route('restaurant.requisitions.create') }}" class="btn-new">
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $req->date_needed ? $req->date_needed->format('Y-m-d') : 'Not set' }}</td>
                        ...
                        <td>
                            <a href="{{ route('restaurant.requisitions.show', $req->id) }}" class="text-blue-600 hover:underline text-sm">
...
<script>
    ...
    document.querySelectorAll('.cancel-requisition').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            cancelForm.action = `/restaurant/requisitions/${requisitionId}/cancel`;
