            ...
            <form id="manualForm" method="POST" action="<?php echo e(route('store.inventory.store')); ?>">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="item_name" id="item_name" class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['item_name'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('item_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="category_id" id="category_id" class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="item_code" id="item_code" class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['item_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Auto-generated if empty" value="<?php echo e(old('item_code')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="metrics" id="metrics" class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['metrics'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="box"         <?php echo e(old('metrics') == 'box' ? 'selected' : ''); ?>>Box (contains multiple pieces)</option>
                            <option value="carton"      <?php echo e(old('metrics') == 'carton' ? 'selected' : ''); ?>>Carton (contains multiple pieces)</option>
                            <option value="crate"       <?php echo e(old('metrics') == 'crate' ? 'selected' : ''); ?>>Crate (contains multiple pieces)</option>
                            <option value="dozen"       <?php echo e(old('metrics') == 'dozen' ? 'selected' : ''); ?>>Dozen (12 pieces)</option>
                            <option value="pack"        <?php echo e(old('metrics') == 'pack' ? 'selected' : ''); ?>>Pack (contains multiple pieces)</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="simpleSection" class="simple-section">
                    ...
                    <input type="number" name="quantity" id="simple_quantity" step="0.01" min="0" value="<?php echo e(old('quantity')); ?>" class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                ...
                <div id="bulkSection" class="bulk-section">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="pieces_per_unit" id="pieces_per_unit" step="1" min="1" value="<?php echo e(old('pieces_per_unit')); ?>" class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['pieces_per_unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="number_of_units" id="number_of_units" step="1" min="1" value="<?php echo e(old('number_of_units')); ?>" class="w-full px-3 py-2 border rounded-lg">
                ...
                <div class="mt-4">
                    ...
                    <textarea name="notes" id="notes" rows="2" class="w-full px-3 py-2 border rounded-lg" placeholder="Batch number, expiry date, etc."><?php echo e(old('notes')); ?></textarea>
                </div>

                <div class="mt-6 flex justify-end gap-3">
                    <a href="<?php echo e(route('store.inventory.index')); ?>" class="px-6 py-2 border rounded-lg text-gray-700 hover:bg-gray-50">Cancel</a>
