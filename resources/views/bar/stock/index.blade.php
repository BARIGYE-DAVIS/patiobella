{{-- resources/views/bar/stock/index.blade.php --}}

@extends('layouts.bar')

@section('title', 'My Stock')

@section('page-title', 'Bar Stock')
...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-5 text-white">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-blue-100 mt-1">Current inventory in bar possession</p>
            </div>
    ...
    <div class="filter-card">
        <form method="GET" action="{{ route('bar.stock.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div>
            ...
            <div>
                <label class="block text-xs font-medium text-gray-700 mb-1">Hide Zero Stock</label>
                <select name="hide_zero" class="filter-input">
                    <option value="">Show All</option>
                    <option value="1" {{ request('hide_zero') == '1' ? 'selected' : '' }}>Hide Zero Stock Items</option>
                </select>
            </div>
            <div class="flex items-end">
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('bar.stock.index') }}" class="bg-gray-300 text-gray-700 px-3 py-2 rounded-lg text-xs hover:bg-gray-400">
            ...
            <table class="data-table" id="stockTable">
                <thead>
                    <tr>
                        ...
                        <th style="width: 10%" class="text-right">Issued</th>
                        <th style="width: 10%" class="text-right">Sold</th>
                        <th style="width: 10%" class="text-right">Consumed</th>
                        <th style="width: 10%" class="text-right">Returned</th>
