...
<?php $__env->startSection('page-title', 'Add New Inventory Item'); ?>
...
<div class="bg-white rounded-lg shadow-sm overflow-hidden">
    ...
    <div class="p-6">
        ...
        <div id="manualSection">
            <form id="manualForm" method="POST" action="<?php echo e(route('store.inventory.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="item_name" id="item_name"
                               class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['item_name'];
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('item_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="category_id" id="category_id"
                                class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <input type="text" name="item_code" id="item_code"
                               class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['item_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                               placeholder="Auto-generated if empty" value="<?php echo e(old('item_code')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="metrics" id="metrics"
                                class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['metrics'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <optgroup label="Direct Units (no unpacking needed)">
                                <option value="kg"          <?php echo e(old('metrics') == 'kg' ? 'selected' : ''); ?>>Kilograms (kg)</option>
                                <option value="litres"      <?php echo e(old('metrics') == 'litres' ? 'selected' : ''); ?>>Litres (L)</option>
                                <option value="pcs"         <?php echo e(old('metrics') == 'pcs' ? 'selected' : ''); ?>>Pieces (pcs)</option>
                                <option value="grams"       <?php echo e(old('metrics') == 'grams' ? 'selected' : ''); ?>>Grams (g)</option>
                                <option value="millilitres" <?php echo e(old('metrics') == 'millilitres' ? 'selected' : ''); ?>>Millilitres (ml)</option>
                            </optgroup>
                            <optgroup label="Pack Units (contain multiple items inside)">
                                <option value="box"    <?php echo e(old('metrics') == 'box' ? 'selected' : ''); ?>>Box</option>
                                <option value="carton" <?php echo e(old('metrics') == 'carton' ? 'selected' : ''); ?>>Carton</option>
                                <option value="crate"  <?php echo e(old('metrics') == 'crate' ? 'selected' : ''); ?>>Crate</option>
                                <option value="dozen"  <?php echo e(old('metrics') == 'dozen' ? 'selected' : ''); ?>>Dozen</option>
                                <option value="pack"   <?php echo e(old('metrics') == 'pack' ? 'selected' : ''); ?>>Pack</option>
                                <option value="sack"   <?php echo e(old('metrics') == 'sack' ? 'selected' : ''); ?>>Sack</option>
                                <option value="set"    <?php echo e(old('metrics') == 'set' ? 'selected' : ''); ?>>Set</option>
                            </optgroup>
                        </select>
                        <?php $__errorArgs = ['metrics'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <select name="base_unit" id="base_unit"
                                    class="w-full px-3 py-2 border border-purple-300 rounded-lg <?php $__errorArgs = ['base_unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="bottle"  <?php echo e(old('base_unit') == 'bottle'  ? 'selected' : ''); ?>>Bottle</option>
                                <option value="can"     <?php echo e(old('base_unit') == 'can'     ? 'selected' : ''); ?>>Can</option>
                                <option value="piece"   <?php echo e(old('base_unit') == 'piece'   ? 'selected' : ''); ?>>Piece</option>
                                <option value="glass"   <?php echo e(old('base_unit') == 'glass'   ? 'selected' : ''); ?>>Glass</option>
                                <option value="plate"   <?php echo e(old('base_unit') == 'plate'   ? 'selected' : ''); ?>>Plate</option>
                                <option value="kg"      <?php echo e(old('base_unit') == 'kg'      ? 'selected' : ''); ?>>Kilogram (kg)</option>
                                <option value="gram"    <?php echo e(old('base_unit') == 'gram'    ? 'selected' : ''); ?>>Gram (g)</option>
                                <option value="litre"   <?php echo e(old('base_unit') == 'litre'   ? 'selected' : ''); ?>>Litre (L)</option>
                                <option value="ml"      <?php echo e(old('base_unit') == 'ml'      ? 'selected' : ''); ?>>Millilitre (ml)</option>
                                <option value="sachet"  <?php echo e(old('base_unit') == 'sachet'  ? 'selected' : ''); ?>>Sachet</option>
                                <option value="egg"     <?php echo e(old('base_unit') == 'egg'     ? 'selected' : ''); ?>>Egg</option>
                                <option value="roll"    <?php echo e(old('base_unit') == 'roll'    ? 'selected' : ''); ?>>Roll</option>
                                <option value="strip"   <?php echo e(old('base_unit') == 'strip'   ? 'selected' : ''); ?>>Strip</option>
                                <option value="unit"    <?php echo e(old('base_unit') == 'unit'    ? 'selected' : ''); ?>>Unit (generic)</option>
                            </select>
                            <div class="help-text">This is what stock will always be counted in</div>
                            <?php $__errorArgs = ['base_unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="simpleSection" class="simple-section">
                    ...
                    <input type="number" name="quantity" id="simple_quantity"
                           step="0.01" min="0" value="<?php echo e(old('quantity')); ?>"
                           class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['quantity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="number" name="number_of_units" id="number_of_units"
                                   step="1" min="1" value="<?php echo e(old('number_of_units')); ?>"
                        ...
                        <div>
                            ...
                            <input type="number" name="pieces_per_unit" id="pieces_per_unit"
                                   step="1" min="1" value="<?php echo e(old('pieces_per_unit')); ?>"
                                   class="w-full px-3 py-2 border rounded-lg <?php $__errorArgs = ['pieces_per_unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__errorArgs = ['pieces_per_unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div>
                        ...
                        <select name="store_id" class="w-full px-3 py-2 border rounded-lg">
                            <option value="1" <?php echo e(old('store_id') == 1 ? 'selected' : ''); ?>>Main Store</option>
                            <option value="2" <?php echo e(old('store_id') == 2 ? 'selected' : ''); ?>>Bar Store</option>
                            <option value="3" <?php echo e(old('store_id') == 3 ? 'selected' : ''); ?>>Cafe Store</option>
                        </select>
                    </div>
                    <div>
                ...
                <div class="mt-4">
                    ...
                    <textarea name="notes" id="notes" rows="2"
                              class="w-full px-3 py-2 border rounded-lg"
                              placeholder="Batch number, expiry date, etc."><?php echo e(old('notes')); ?></textarea>
                </div>
        ...
        <div id="grnSection" style="display: none;">
            <div class="bg-green-50 p-4 rounded-lg mb-4">
                ...
                <select id="grn_select" class="w-full px-3 py-2 border rounded-lg">
                    ...
                    <?php $__currentLoopData = $grns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($grn->id); ?>">
                            <?php echo e($grn->grn_number); ?> - <?php echo e($grn->vendor->name ?? 'N/A'); ?> - <?php echo e($grn->received_date->format('Y-m-d')); ?>
            ...
            <div id="grnItemsContainer" style="display: none;">
                <form method="POST" action="<?php echo e(route('store.inventory.store-from-grn')); ?>" id="grnForm">
                    <?php echo csrf_field(); ?>
...
function showPreview() {
    ...
    const oldMetrics = '<?php echo e(old("metrics")); ?>';
    if (oldMetrics) {
        metricsSelect.value = oldMetrics;
        updateManualForm();
    }
    const oldBaseUnit = '<?php echo e(old("base_unit")); ?>';
    if (oldBaseUnit) {
...
<?php echo $__env->make('layouts.store', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\patiobella\resources\views/store/inventory/create.blade.php ENDPATH**/ ?>