        ...
        <div id="sidebar" class="bg-dark min-h-screen flex flex-col z-50">
            ...
            <nav class="mt-2 flex-1">
                ...
                <a href="{{ route('dashboard') }}"
                   ...
                   class="nav-item flex items-center px-[18px] py-3 gap-3 text-gray-300 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('dashboard') ? 'bg-primary text-white' : '' }}">
                ...
                <a href="{{ route('users.index') }}"
                   data-tooltip="Users"
                   class="nav-item flex items-center px-[18px] py-3 gap-3 text-gray-300 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('users.*') ? 'bg-primary text-white' : '' }}">
                ...
                <a href="{{ route('departments.index') }}"
                   ...
                   class="nav-item flex items-center px-[18px] py-3 gap-3 text-gray-300 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('departments.*') ? 'bg-primary text-white' : '' }}">
                ...
                <a href="{{ route('roles.index') }}"
                   ...
                   class="nav-item flex items-center px-[18px] py-3 gap-3 text-gray-300 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('roles.*') ? 'bg-primary text-white' : '' }}">
            ...
            <nav class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-40">
                <div class="px-4 py-3 flex items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        @endauth
                        <h1 class="text-xl font-semibold text-gray-800">@yield('title', 'Patio Bella')</h1>
                    </div>
