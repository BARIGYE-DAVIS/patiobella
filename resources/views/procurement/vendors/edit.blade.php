    ...
    <form method="POST" action="{{ route('procurement.vendors.update', $vendor->id) }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="vendor_code" value="{{ $vendor->vendor_code }}" readonly
            ...
            <div>
                ...
                <input type="text" name="alternative_phone" value="{{ old('alternative_phone', $vendor->alternative_phone) }}"
            ...
            <div>
                ...
                <input type="number" name="credit_limit" value="{{ old('credit_limit', $vendor->credit_limit) }}"
