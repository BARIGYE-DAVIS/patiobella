            ...
            <div class="flex items-center justify-between flex-wrap gap-4">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Update reservation information</p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-orange-100">
            ...
            <div class="bg-gradient-to-r from-orange-500 to-amber-500 px-6 py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <h3 class="text-white font-semibold text-lg">Edit Reservation</h3>
                </div>
                <p class="text-orange-100 text-sm mt-1 ml-9">Update the reservation details below</p>
            </div>

            <form method="POST" action="{{ route('management.reservations.update', $reservation->id) }}" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="reservation_date" id="reservation_date" value="{{ old('reservation_date', $reservation->reservation_date) }}" required
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" name="reservation_time" id="reservation_time" value="{{ old('reservation_time', date('H:i', strtotime($reservation->reservation_time))) }}" required
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <select name="duration_hours" id="duration_hours" required
                                    class="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-orange-400 focus:ring-4 focus:ring-orange-100 transition-all duration-200">
                                <option value="1" {{ old('duration_hours', $reservation->duration_hours) == 1 ? 'selected' : '' }}>1 Hour</option>
                                <option value="2" {{ old('duration_hours', $reservation->duration_hours) == 2 ? 'selected' : '' }}>2 Hours</option>
                                <option value="3" {{ old('duration_hours', $reservation->duration_hours) == 3 ? 'selected' : '' }}>3 Hours</option>
                                <option value="4" {{ old('duration_hours', $reservation->duration_hours) == 4 ? 'selected' : '' }}>4 Hours</option>
                            </select>
                        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <select name="status" id="status" required
                                    class="w-full pl-10 pr-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-orange-400 focus:ring-4 focus:ring-orange-100 transition-all duration-200 @error('status') border-red-400 bg-red-50 @enderror">
                    ...
                    <div class="md:col-span-2 space-y-2">
                        ...
                        <div class="relative">
                            <textarea name="notes" id="notes" rows="3"
                                      ...
                                      class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-orange-400 focus:ring-4 focus:ring-orange-100 transition-all duration-200 resize-none @error('notes') border-red-400 bg-red-50 @enderror">{{ old('notes', $reservation->notes) }}</textarea>
                        </div>
                        @error('notes')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="mt-6 grid grid-cols-2 md:grid-cols-3 gap-4 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
                    <div class="text-center">
                        <div class="text-2xl font-bold text-orange-600">{{ $reservation->created_at->format('M d, Y') }}</div>
                        <div class="text-xs text-gray-600">Created Date</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-orange-600">{{ $reservation->updated_at->format('M d, Y') }}</div>
                        <div class="text-xs text-gray-600">Last Updated</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-orange-600">{{ $reservation->status }}</div>
                        <div class="text-xs text-gray-600">Current Status</div>
                    </div>
                </div>
