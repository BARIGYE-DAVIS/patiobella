...
class VendorRatingController extends Controller
{
    ...
    public function create($grnId)
    {
        ...
        if ($grn->isRated()) {
            return redirect()->route('procurement.goods-received.show', $grnId)
        ...
        return view('procurement.vendor-ratings.create', compact('grn'));
    }
    ...
    /**
     * Display all ratings for a specific vendor.
     */
    public function vendorRatings($vendorId)
    {
        ...
        return view('procurement.vendor-ratings.vendor-ratings', compact('vendor', 'ratings'));
    }

    /**
     * Display all ratings across all vendors.
     */
    public function index(Request $request)
    {
        ...
        return view('procurement.vendor-ratings.index', compact('ratings', 'vendors'));
    }
