...
<div id="requisitionPrintArea">
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden print-hide">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center flex-wrap gap-3">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('restaurant.requisitions.index') }}" class="text-gray-600 hover:text-gray-800 text-sm font-medium transition flex items-center gap-1">
                    <i class="fas fa-arrow-left"></i> Back
                </a>
                @if($requisition->status == 'pending')
                <form method="POST" action="{{ route('restaurant.requisitions.cancel', $requisition->id) }}" class="inline" onsubmit="return confirm('Cancel this requisition?')">
                    @csrf
                    @method('DELETE')
    ...
    <div class="print-header hidden">
        <div style="text-align: center; margin-bottom: 20px; border-bottom: 2px solid #f97316; padding-bottom: 15px;">
            <h1 style="margin: 0; color: #1f2937; font-size: 24px;">RESTAURANT REQUISITION FORM</h1>
            <p style="margin: 5px 0 0; color: #6b7280; font-size: 12px;">Official Restaurant Requisition Document</p>
        </div>
    </div>
    ...
    <div class="p-6">
        ...
        <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
                ...
                <div>
                    <i class="fas fa-shopping-cart text-amber-400 text-lg mb-1"></i>
                    <p class="text-xs text-gray-500">Total Sold / Used</p>
                    <p class="text-xl font-bold text-amber-600">{{ number_format($totalSold, 2) }}</p>
                </div>
                <div>
        ...
        <div class="mb-6">
            <h4 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                <i class="fas fa-sticky-note mr-1"></i> Restaurant Notes
            </h4>
                ...
                <table class="min-w-full text-sm">
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="text-center px-4 py-3 font-semibold text-amber-600 bg-amber-50 w-[9%]">Sold / Used</th>
                    ...
                    <tfoot class="bg-gray-50 border-t border-gray-200">
                        <tr>
                            ...
                            <td class="px-4 py-3 text-center font-bold text-amber-600">{{ number_format($totalSold, 2) }}</td>
