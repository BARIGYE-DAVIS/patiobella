...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form method="POST" action="{{ route('store.stock-counts.review-approve', $stockCount->id) }}" id="reviewForm">
            @csrf
                                ...
                                <tr class="hover:bg-yellow-50 transition-colors duration-150" data-item-id="{{ $item->id }}" data-has-variance="{{ $hasVariance ? 'true' : 'false' }}">
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        <input type="text"
                                               ...
                                               class="hidden reason-notes-{{ $item->id }} w-full mt-1 px-2 py-1 border border-gray-300 rounded-lg text-sm"
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4 p-3 bg-white rounded-lg border border-gray-200">
                    ...
                    <div class="text-center">
                        <p class="text-xs text-gray-500">Items with Variance</p>F
