    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between flex-wrap gap-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('management.stock-counts.approve-count', $stockCount->id) }}"
                ...
                <a href="{{ route('management.stock-counts.download-pdf', $stockCount->id) }}"
                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-3 py-2 text-center">Physical Qty</th>
                            <th class="px-3 py-2 text-center">Empty Weight</th>
                            <th class="px-3 py-2 text-left">Reason for Variance</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($stockCount->items as $item)
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-3 py-2 text-center">
                                <input type="number" name="items[{{ $loop->index }}][physical_quantity]" step="any"
                                       class="w-28 px-2 py-1 border border-gray-300 rounded-lg text-center"
                                       value="{{ $item->physical_quantity }}">
                            </td>
                            <td class="px-3 py-2 text-center">
                                <span class="text-orange-600">{{ number_format($emptyWeight, 3) }} kg</span>
                                <input type="hidden" name="items[{{ $loop->index }}][empty_bottle_weight]" value="{{ $emptyWeight }}">
                            </td>
                            <td class="px-3 py-2">
                                <input type="text" name="items[{{ $loop->index }}][reason_notes]" class="w-full px-2 py-1 border border-gray-300 rounded-lg text-sm" value="{{ $item->reason_notes }}" placeholder="Optional notes...">
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
