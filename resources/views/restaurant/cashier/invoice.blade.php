{{-- resources/views/restaurant/cashier/invoice.blade.php --}}
...
<div class="no-print" style="max-width: 320px; margin: 0 auto 12px auto;">
    <div class="flex justify-between gap-2">
        <a href="{{ route('restaurant.cashier.orders') }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg text-sm flex items-center gap-1">
...
<script>
    ...
    function processPayment() {
        ...
        fetch('{{ route("restaurant.cashier.mark-as-paid", $order->id) }}', {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if (data.success) {
                window.location.href = '{{ route("restaurant.cashier.receipt", $order->id) }}';
            } else {
