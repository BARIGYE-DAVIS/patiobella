...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Procurement Module'); ?> - <?php echo e(config('app.name')); ?></title>
...
<aside id="sidebar" class="text-white shadow-xl">
    ...
    <nav class="mt-6">
        <a href="<?php echo e(route('procurement.dashboard')); ?>"
           class="flex items-center px-4 py-3 text-sm hover:bg-blue-700 transition sidebar-nav-link
                  <?php echo e(request()->routeIs('procurement.dashboard') ? 'sidebar-active' : ''); ?>">
        ...
        <a href="<?php echo e(route('procurement.requisitions.index')); ?>"
           class="flex items-center px-4 py-3 text-sm hover:bg-blue-700 transition sidebar-nav-link
                  <?php echo e(request()->routeIs('procurement.requisitions.*') ? 'sidebar-active' : ''); ?>">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="<?php echo e(route('procurement.purchase-orders.index')); ?>"
           class="flex items-center px-4 py-3 text-sm hover:bg-blue-700 transition sidebar-nav-link
                  <?php echo e(request()->routeIs('procurement.purchase-orders.*') ? 'sidebar-active' : ''); ?>">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="<?php echo e(route('procurement.lpo.index')); ?>"
           class="flex items-center px-4 py-3 text-sm hover:bg-blue-700 transition sidebar-nav-link
                  <?php echo e(request()->routeIs('procurement.lpo.*') ? 'sidebar-active' : ''); ?>">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
  ...
  <a href="<?php echo e(route('procurement.approved-lpos.index')); ?>"
   class="flex items-center px-4 py-3 text-sm hover:bg-blue-700 transition sidebar-nav-link
          <?php echo e(request()->routeIs('procurement.approved-lpos.*') ? 'sidebar-active' : ''); ?>">
    ...
    <span class="ml-auto text-xs bg-green-600 px-2 py-0.5 rounded-full">EPO</span>
        ...
        <a href="<?php echo e(route('procurement.vendors.index')); ?>"
           class="flex items-center px-4 py-3 text-sm hover:bg-blue-700 transition sidebar-nav-link
                  <?php echo e(request()->routeIs('procurement.vendors.*') ? 'sidebar-active' : ''); ?>">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<a href="<?php echo e(route('procurement.goods-received.index')); ?>"
   class="flex items-center px-4 py-3 text-sm hover:bg-blue-700 transition sidebar-nav-link
          <?php echo e(request()->routeIs('procurement.goods-received.*') ? 'sidebar-active' : ''); ?>">
    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
    </svg>
        ...
        <div class="flex items-center">
            <div class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center flex-shrink-0">
                <span class="text-sm font-bold">
                    <?php echo e(substr(Auth::user()->first_name ?? 'U', 0, 1)); ?><?php echo e(substr(Auth::user()->last_name ?? '', 0, 1)); ?>

                </span>
            </div>
            <div class="ml-3 overflow-hidden">
                <p class="text-sm font-medium truncate"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?></p>
                <p class="text-xs text-blue-300"><?php echo e(Auth::user()->role ?? 'Procurement Officer'); ?></p>
            </div>
        </div>
...
<div class="top-bar">
    ...
    <div class="flex items-center gap-4">
        <a href="<?php echo e(route('dashboard')); ?>" class="text-gray-600 hover:text-gray-800 text-sm hidden sm:inline-flex items-center gap-1">
...
<script>
    ...
    function checkPendingRequisitions() {
        fetch('<?php echo e(route("procurement.notifications.check")); ?>', {
            method: 'GET',
            headers: {
...
<?php /**PATH C:\xampp\htdocs\patiobella\resources\views/layouts/procurement.blade.php ENDPATH**/ ?>