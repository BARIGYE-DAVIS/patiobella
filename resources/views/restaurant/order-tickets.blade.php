...
@section('title', 'Cafe Order Tickets')

@section('content')
<div class="max-w-7xl mx-auto px-4 pb-8">

    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Cafe Order Tickets</h1>
        <p class="text-sm text-gray-500 mt-0.5">Manage cafe orders from waiters</p>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800">{{ $activeTickets->count() }}</p>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-lg font-semibold text-gray-800">
                        <i class="fas fa-mug-hot text-orange-500 mr-2"></i>
                        Active Orders
                    </h2>
...
<script>
    ...
    function printTicket(ticketId) {
        window.open('/cafe/tickets/' + ticketId + '/print', '_blank', 'width=400,height=500');
    }

    function completeTicket(ticketId) {
        if (!confirm('Mark this order as completed?')) return;

        fetch('/cafe/tickets/' + ticketId + '/complete', {
            method: 'POST',
            headers: {
